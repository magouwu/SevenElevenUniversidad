...
<?php } ?>
 <?php require_once('Connections/conexiontienda.php'); ?>
  ...
  <div class="content">
    <h1><!-- InstanceBeginEditable name="Contenido" -->Error<!-- InstanceEndEditable --></h1>
    <!-- InstanceBeginEditable name="EditRegion4" -->Tu usuario o contraseña son erroneas.<!-- InstanceEndEditable --><!-- end .content --></div>
  <div class="footer">
    <p>Seven</p>
